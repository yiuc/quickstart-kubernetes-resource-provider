...
1. Write the JSON schema describing your resource, `awsqs-kubernetes-resource.json`
2. Implement your resource handlers in `awsqs_kubernetes_resource/handlers.py`
